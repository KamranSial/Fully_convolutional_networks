...
class FCN32VGG:
    ...
    def get_conv_filter(self, filter_size, in_channels, out_channels, name):
        if self.data_dict is not None and name in self.data_dict:
            ...
            std=sqrt(2/(filter_size*filter_size*out_channels))
            init=tf.random_normal_initializer(0.0,std)
            shape=[filter_size, filter_size, in_channels, out_channels]
            print (name, "mcs Initialization")
    ...
    def _variable_with_weight_decay(self, shape, stddev, wd):
        ...
        if self.data_dict is not None:
            ...
            print ("fc8", " 2d Value mcs Initialized")
    ...
    def get_fc_weight_reshape(self, name, shape, num_classes=None):
        ...
        if self.data_dict is not None and name in self.data_dict:
            ...
            print (name, "2d Value mcs Initialized")
        var=tf.get_variable(name="weights", initializer=init, shape=shape)
        self.var_dict[(name, 0)] = var
